...
sleep 4
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://github.com/perumblokh/upd/raw/main/udp-custom-linux-amd64" -O /root/udp/udp-custom && rm -rf /tmp/cookies.txt
...
sleep 4
clear
wget -q --show-progress --load-cookies /tmp/cookies.txt "https://github.com/perumblokh/upd/raw/main/config.json" -O /root/udp/config.json && rm -rf /tmp/cookies.txt
